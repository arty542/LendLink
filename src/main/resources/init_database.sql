...
CREATE TABLE Transaction (
    ...
    type ENUM('funding', 'repayment', 'deposit', 'withdrawal') NOT NULL,
...
INSERT INTO Transaction (transaction_id, from_user_id, to_user_id, amount, timestamp, type) VALUES
(1, 2, 1, 5000.00, '2024-02-02 14:30:00', 'funding'),
(2, 4, 1, 5000.00, '2024-02-02 16:45:00', 'funding'),
(3, 1, 2, 450.00, '2024-03-02 10:00:00', 'repayment'),
(4, 2, 3, 7500.00, '2024-02-04 17:20:00', 'funding'),
(5, 3, 2, 675.00, '2024-03-04 09:30:00', 'repayment'),
(6, 5, 2, 1000.00, '2024-03-05 11:15:00', 'deposit'),
(7, 4, 1, 500.00, '2024-03-06 14:20:00', 'withdrawal');
